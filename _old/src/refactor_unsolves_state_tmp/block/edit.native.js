 ...
 */
const { View, TouchableWithoutFeedback, Text } = 'react-native';
...
const { withPreferredColorScheme, compose } = wp.compose;
const {
	BlockCaption,
	MediaPlaceholder,
	MediaUpload,
...
const { isURL, getProtocol } = '@wordpress/url';
const { doAction, hasAction } = '@wordpress/hooks';
const { video as SvgIcon, replace } = wp.icons;
