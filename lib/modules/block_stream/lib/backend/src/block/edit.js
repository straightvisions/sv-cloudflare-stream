...
import svCloudflareStream from './cloudflare';
...
function VideoEdit( {
	...
	console.log(svCloudflareStream);
	const mediaFrame = new svCloudflareStream.media.view.MediaFrame();
	// stream lib functions ----------------------------------------------------------------------
	const media = new MediaFrame();
	function openMediaLib(){
		const block = this;
		
		media.open();
		
		media.on( 'delete', function( attachment ) {
